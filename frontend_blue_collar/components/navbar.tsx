    ...
    <nav className="sticky top-0 z-50 w-full border-b border-solid border-gray-200 dark:border-gray-800 bg-white/90 dark:bg-gray-950/90 backdrop-blur-sm">
      <div className="container flex h-16 items-center">
        ...
        <div className="hidden md:flex flex-grow justify-center items-center gap-8">
          ...
          <button
            onClick={() => scrollToSection('job-types')}
            className="text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
          >
            Job Types
          </button>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden border-t border-gray-200 dark:border-gray-800">
          <div className="container py-4 space-y-4">
            <button
              onClick={() => scrollToSection('how-it-works')}
              className="block w-full text-left text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400"
            >
              How It Works
            </button>
            <button
            ...
            <div className="pt-4 flex flex-col gap-2">
              ...
              <Link href="/login" onClick={() => setIsMobileMenuOpen(false)}>
                <Button variant="ghost" className="w-full justify-start hover:text-blue-600 dark:hover:text-blue-400">
                  Sign In
                </Button>
              </Link>
              <Link 
              ...
              >
                <Button className="w-full justify-start bg-blue-600 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700 text-white">
                  Call Now
                </Button>
              </Link>
            </div>
